# ParekPractitionerRole - Pasientens rekvisisjoner v0.1.7
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/ParekIG/StructureDefinition/parek-practitioner-role | *Version*:0.1.7 |
| Draft as of 2026-04-16 | *Computable Name*:ParekPractitionerRole |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://hl7.no/fhir/ig/ParekIG/ValueSet/healthcare-person-id-type-vs"
      }
    },
    {
