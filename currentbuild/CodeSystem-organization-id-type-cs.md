# Organization Id Type CS - Pasientens rekvisisjoner v0.1.4
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/ParekIG/CodeSystem/organization-id-type-cs | *Version*:0.1.4 |
| Draft as of 2026-04-10 | *Computable Name*:OrganizationIdType_CS |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-04-10T12:03:27+00:00",
